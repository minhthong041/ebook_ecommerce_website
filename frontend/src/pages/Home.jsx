...
// Chú ý: Vì file này nằm trong pages/, nên đường dẫn trỏ ra ngoài lấy api và css phải thêm ../
import { apiClient } from '../api/client' 
import '../App.css'

const Home = () => { // Đổi tên function từ App thành Home
    ...
    <main className="app-shell">
      <section className="workspace-header">
        <div>
          ...
          <p className="summary">
            Django, PostgreSQL, and React are wired together for local development.
          </p>
        </div>
        <button
          type="button"
...
export default Home; // Xuất function Home